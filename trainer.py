...
class ImprovedTrainer:
    def __init__(self, env, input_shape, action_shape, learning_rate=1e-4):
        ...
        self.replay_buffer = ReplayBuffer(capacity=162000)
    ...
    def training(self, episodes=200, batch_size=2**11):
        ...
        for episode in range(episodes):
            ...
            if blue_agents:  # Only calculate metrics if there are blue agents
